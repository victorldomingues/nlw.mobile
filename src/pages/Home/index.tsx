        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
            <ImageBackground style={styles.container} source={require('../../assets/home-background.png')} imageStyle={{ width: 274, height: 368 }} >
                ...
                <View style={styles.footer}>
                    <TextInput style={styles.input} placeholder='Digite a UF' onChangeText={setState} value={state} maxLength={2} autoCapitalize='characters' autoCorrect={false}>

                    </TextInput>
                    <TextInput style={styles.input} placeholder='Digite a cidade' onChangeText={setCity} value={city} autoCorrect={false}>
